...
public class HumanSlingVersusEvoAgent {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SimplePlayerInterface mctsAgent1 = getMCTSAgent(gameState, Constants.playerOne, true);
    ...
    static GVGAIWrapper getMCTSAgent(SpinGameState gameState, int playerId, boolean reuseTree){
        ...
        if (reuseTree) {
            agent = new Agent(linkState.copy(), timer, playerId);
        } else {
            agent = new teamZero.spinbattle.controllers.multiPlayer.discountOLMCTS.Agent(linkState.copy(), timer, playerId);
        }
